# Compares two dates and returns a hash with the difference in seconds, minutes, hours, and days - Shows how much time is left for a person that's had their commuications suspended
module CompareDates
